...
namespace heisenberg::rock_core::object_physics_body_set
{
    ...
    struct BodySetScanOptions
    {
        ...
        std::uint32_t seedBodyId = INVALID_BODY_ID;
        grab_target::Kind targetKind = grab_target::Kind::LooseObject;
        RE::NiAVObject* seedHitNode = nullptr;
    ...
    struct BodySetDiagnostics
    {
        ...
        std::uint32_t seedBodiesAdded = 0;
        std::uint32_t scanFailures = 0;
        std::uint32_t benignScanSkips = 0;
        std::uint32_t invalidPhysicsSystems = 0;
        std::uint32_t foreignRefBodySkips = 0;
