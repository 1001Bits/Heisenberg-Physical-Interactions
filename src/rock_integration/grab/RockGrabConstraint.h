...
#include "rock_integration/grab/PhysicsLog.h"
...
namespace heisenberg::rock_core
{
    ...
    // [GC-DIAG] runtime block of the most recently registered grab constraint (solver-results
    // window). Diagnostic only — do not dereference after the constraint is retired.
