...
namespace heisenberg::rock_core::active_object_prep_policy
{
    /*
...
namespace heisenberg::rock_core::active_grab_body_lifecycle
{
...
namespace heisenberg::rock_core::grab_interaction_policy
{
    /*
...
namespace heisenberg::rock_core::grab_frame_math
{
...
namespace heisenberg::rock_core::grab_authority_frame_math
{
...
namespace heisenberg::rock_core::pull_motion_math
{
    template <class Vec3>
