...
namespace heisenberg::rock_core::physics_scale
{
    /*
     * ROCK must not guess the game/Havok conversion from round numbers or from
     * FRIK's player VR scale. FO4VR already owns the hknp unit scale, so keeping
     * that distinction centralized prevents distance-from-origin drift while
     * still letting diagnostics report FRIK's live scale separately.
     */
