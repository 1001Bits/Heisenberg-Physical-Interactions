...
namespace rock::collision_suppression_registry
{
    ...
    enum class CollisionSuppressionOwner : std::uint8_t
    {
        ...
        HostExternal = 6,  // host plugin API lease (Virtual Reloads etc.), Jul 19
    };
    ...
    enum class RuntimeSuppressionLogMode : std::uint8_t
    {
        Detailed,
        CallerAggregates,
    };
    ...
    public:
        RuntimeSuppressionResult acquire(
            ...
            const char* context,
            RuntimeSuppressionLogMode logMode = RuntimeSuppressionLogMode::Detailed);
        RuntimeSuppressionResult release(
            RE::hknpWorld* world,
            std::uint32_t bodyId,
            CollisionSuppressionOwner owner,
            const char* context,
