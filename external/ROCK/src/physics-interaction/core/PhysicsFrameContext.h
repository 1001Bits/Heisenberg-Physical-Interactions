...
namespace rock
{
    ...
    struct HandFrameInput
    {
        ...
        // Heisenberg-preserved grab-locomotion authority bridge (upstream removed
        // it in 6452acd). rawHandWorld carries the bridge lead; unbridgedRawHandWorld
        // is the raw controller pose before it, and the offset is the difference.
