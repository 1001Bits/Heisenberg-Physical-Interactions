...
namespace rock::held_object_physics_math
{
    ...
    /*
     * Heisenberg-preserved held player-space helpers (upstream removed the grab
     * player-space subsystem in 6452acd). Used by
     * PhysicsInteraction::sampleHeldObjectPlayerSpaceFrame /
     * applyHeldPlayerSpaceVelocity and by the release-velocity composition.
     */
    template <class Vec3>
